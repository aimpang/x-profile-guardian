...
import { Shield, ArrowRight, Eye, EyeOff, Lock, Mail } from "lucide-react";
      ...
      <div className="w-full max-w-sm">
        <div className="flex flex-col items-center gap-2 mb-8">
          ...
          <p className="text-sm text-muted-foreground text-center">
            Sign in to access your dashboard, settings and alerts.
          </p>
        </div>

        <Button
          variant="outline"
          className="w-full gap-2 border-border bg-secondary/50 text-foreground"
