  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-6">
      <div className="w-full max-w-sm">
        ...
        <Button
          variant="outline"
          className="w-full mb-4 border-border bg-secondary/50 text-foreground gap-2"
        ...
        <form onSubmit={handleSignup} className="space-y-4">
          ...
          <div>
            ...
            <Input id="password" type="password" value={password} onChange={e => setPassword(e.target.value)} placeholder="••••••••" minLength={6} required className="mt-1.5 bg-secondary/50 border-border" />
          </div>
