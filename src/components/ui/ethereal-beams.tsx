...
const DirLight: FC<{ position: [number, number, number]; color: string }> = ({ position, color }) => {
  ...
  return <directionalLight ref={dir} position={position} color={color} intensity={6} castShadow />
}
...
export function EtherealBeamsBackground(props: BeamsProps) {
  return (
